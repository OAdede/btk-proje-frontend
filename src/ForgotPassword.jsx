...
function ForgotPassword({ onBack }) {
  ...
  const handleSubmit = (e) => {
    ...
    setMessage('Şifre sıfırlama talebiniz yöneticiye gönderildi. En kısa sürede dönüş yapılacaktır.');
    setIsSuccess(true);
    setUsername('');
  };
      ...
      <Paper elevation={16} sx={{
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', mb: 2 }}>
          ...
          <Typography variant="subtitle1" color="#6b7280" align="center" mb={1} sx={{ fontWeight: 400, fontFamily: 'Inter, Segoe UI, Arial, sans-serif' }}>
            Kullanıcı adınızı girin, yöneticiye talep gönderilsin
          </Typography>
        </Box>
        ...
        <Box component="form" onSubmit={handleSubmit}>
          ...
          {message && (
            <Alert severity={isSuccess ? "success" : "error"} sx={{ mt: 2, mb: 1, borderRadius: 2, textAlign: 'center', fontFamily: 'Inter, Segoe UI, Arial, sans-serif' }}>
              {message}
            </Alert>
          )}
          ...
          <Button 
            ...
            sx={{ 
              ...
              background: 'linear-gradient(90deg, #2d8cff 0%, #7f9cf5 100%)' 
            }}
          >
            Admine Talep Gönder
          </Button>
