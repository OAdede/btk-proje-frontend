...
function MenuUpdate({ onMenuChange }) {
  ...
  const tumUrunler = Object.entries(menu).flatMap(([kategori, urunler]) =>
    urunler.map((u) => ({ ...u, kategori }))
  );
  const gosterilecekUrunler =
    aktifKategori === "Tümü"
      ? tumUrunler
      : (menu[aktifKategori] || []).map((u) => ({
        ...u,
  ...
  return (
    ...
    >
      <h2 style={{ margin: "0 0 16px 0", color: "#1a3c34", fontWeight: 700 }}>
        Menü Güncelleme
      </h2>
      ...
      {aktifKategori !== "Tümü" && (
        ...
        >
          <h3 style={{ margin: "0 0 16px 0", color: "#1a3c34" }}>
            Yeni Ürün Ekle
          </h3>
          <div
            style={{
      ...
      <div style={{ display: "grid", gap: 16 }}>
        {gosterilecekUrunler.map((urun, index) => (
          ...
          >
            <div>
              <h4 style={{ margin: "0 0 4px 0", color: "#1a3c34" }}>
                {urun.ad}
              </h4>
      ...
      {duzenleModal.acik && (
        ...
        >
          ...
          >
            <h3 style={{ margin: "0 0 16px 0", color: "#1a3c34" }}>
              Ürün Düzenle: {duzenleModal.urun?.ad}
            </h3>
            <div style={{ display: "grid", gap: 16 }}>
              <div>
                <label
                  style={{ display: "block", marginBottom: 4, color: "#1a3c34" }}
                >
                  Ürün Adı:
                </label>
                <input
