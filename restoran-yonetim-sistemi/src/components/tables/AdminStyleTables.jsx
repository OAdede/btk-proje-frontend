...
export default function AdminStyleTables({ roleOverride }) {
    ...
    const { tableStatus, reservations, updateTableStatus, orders } = useContext(TableContext);
    ...
    const getCapacity = (tableNumber) => tableCapacities?.[tableNumber] || 4;
