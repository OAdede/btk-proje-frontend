    ...
    <Box sx={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #e0e7ff 0%, #f8fafc 100%)', fontFamily: 'Inter, Segoe UI, Arial, sans-serif' }}>
      <Paper elevation={16} sx={{
        ...
        <Box component="form" onSubmit={handleSubmit}>
          ...
          <Button onClick={onForgotPassword} color="secondary" fullWidth sx={{ mt: 1, borderRadius: 3, fontWeight: 500, fontFamily: 'Inter, Segoe UI, Arial, sans-serif', color: '#2d8cff', background: '#f1f5f9', ':hover': { background: '#e0e7ff' } }}>
            Şifremi Unuttum
          </Button>
        </Box>
      </Paper>
